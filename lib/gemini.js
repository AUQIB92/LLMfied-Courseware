...
ALWAYS follow the above formatting rules strictly to ensure correct math rendering.
    ...
    7. Detailed subsections with MULTI-PAGE EXPLANATIONS:
       ...
       CRITICAL: For each detailed subsection, you MUST create MULTIPLE PAGES of detailed explanation (around 8 pages):
       
       CONCEPT-FOCUSED PAGES (Pages 1-5):
       - MANDATORY: Page 1: "Introduction & Foundation" - Basic concepts, definitions, context, why this concept matters
       - MANDATORY: Page 2: "Core Theory & Principles - Part 1" - Deep dive into theoretical understanding and fundamental principles
       - MANDATORY: Page 3: "Core Theory & Principles - Part 2" - Advanced theoretical concepts and deeper understanding
       - MANDATORY: Page 4: "Essential Formulas & Derivations" - Key formulas with step-by-step derivations and proofs
       - MANDATORY: Page 5: "Concept Applications & Examples" - How the concept applies in various scenarios with detailed examples
       
       EXAM-FOCUSED PAGES (Pages 6-8):
       - MANDATORY: Page 6: "Exam Strategies & Speed Techniques" - Time-saving methods, shortcuts, memory tricks, and rapid calculation techniques
       - MANDATORY: Page 7: "Common Traps & Error Prevention" - Typical mistakes, question traps, and error prevention strategies
       - MANDATORY: Page 8: "Key Takeaways & Exam Readiness" - Essential points summary, quick revision notes, and final exam preparation checklist
       
       REQUIREMENTS FOR EACH PAGE:
       - Each page MUST have a clear, descriptive title
       - Each page MUST contain substantive content
