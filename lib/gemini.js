...
export async function generateCompetitiveExamModuleSummary(content, context = {}) {
  ...
  const prompt = `
    ...
    7. Detailed subsections with MULTI-PAGE EXPLANATIONS:
       ...
       CRITICAL: For each detailed subsection, you MUST create EXACTLY 12 PAGES of detailed explanation:
       
       CONCEPT-FOCUSED PAGES (Pages 1-10):
       - MANDATORY: Page 1: "Introduction & Foundation" (300-400 words) - Basic concepts, definitions, context, why this concept matters
       - MANDATORY: Page 2: "Core Theory & Principles - Part 1" (300-400 words) - Deep dive into theoretical understanding and fundamental principles
       - MANDATORY: Page 3: "Core Theory & Principles - Part 2" (300-400 words) - Advanced theoretical concepts and deeper understanding
       - MANDATORY: Page 4: "Essential Formulas & Derivations - Part 1" (300-400 words) - Key formulas with step-by-step derivations and proofs
       - MANDATORY: Page 5: "Essential Formulas & Derivations - Part 2" (300-400 words) - Additional formulas, variations, and advanced derivations
       - MANDATORY: Page 6: "Concept Applications & Examples - Part 1" (300-400 words) - How the concept applies in various scenarios with detailed examples
       - MANDATORY: Page 7: "Concept Applications & Examples - Part 2" (300-400 words) - Advanced applications and complex real-world scenarios
       - MANDATORY: Page 8: "Conceptual Problem Solving - Part 1" (300-400 words) - Systematic approach to solving basic and intermediate problems
       - MANDATORY: Page 9: "Conceptual Problem Solving - Part 2" (300-400 words) - Advanced problem-solving techniques and complex scenarios
       - MANDATORY: Page 10: "Mastery Integration & Synthesis" (300-400 words) - Integration of all concepts and comprehensive understanding
       
       EXAM-FOCUSED PAGES (Pages 11-12):
       - MANDATORY: Page 11: "Short Tricks & Speed Techniques" (300-400 words) - Time-saving methods, shortcuts, memory tricks, and rapid calculation techniques
       - MANDATORY: Page 12: "Key Takeaways & Exam Readiness" (300-400 words) - Essential points summary, quick revision notes, and final exam preparation checklist
        ...
        "detailedSubsections": [
          {
            ...
            "pages": [
              {
                "pageNumber": 1,
                "pageTitle": "Core Theory & Principles - Part 1: Foundation",
                "content": "Introduction to fundamental concepts and basic theoretical framework (300-400 words). This page establishes the core foundation of the topic.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "formula|equation|definition",
                    "title": "Fundamental Definition",
                    "content": "Basic mathematical expression or core principle",
                    "explanation": "Step-by-step explanation of the fundamental concept",
                    "example": "Simple numerical example demonstrating the concept"
                  }
                ],
              ...
              {
                "pageNumber": 2,
                "pageTitle": "Core Theory & Principles - Part 2: Deep Concepts",
                "content": "Advanced theoretical understanding and principle development (300-400 words). This page explores deeper theoretical aspects.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "theorem|principle|derivation",
                    "title": "Core Theoretical Principle",
                    "content": "Advanced mathematical principle or theorem",
                    "explanation": "Detailed theoretical explanation and derivation",
                    "example": "Complex example showing principle application"
                  }
                ],
                "keyTakeaway": "Deep theoretical understanding and principle mastery"
              },
              {
                "pageNumber": 3,
                "pageTitle": "Core Theory & Principles - Part 3: Mathematical Framework",
                "content": "Complete mathematical framework and formula development (300-400 words). This page covers all essential formulas and their relationships.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "formula|equation|relationship",
                    "title": "Essential Mathematical Framework",
                    "content": "Complete set of related formulas and equations",
                    "explanation": "How formulas connect and relate to each other",
                    "example": "Comprehensive example using multiple formulas"
                  }
                ],
                "keyTakeaway": "Complete mathematical framework mastery"
              },
              {
                "pageNumber": 4,
                "pageTitle": "Core Theory & Principles - Part 4: Advanced Applications",
                "content": "Advanced applications of core theory and complex problem solving (300-400 words). This page demonstrates sophisticated use of principles.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "application|advanced|complex",
                    "title": "Advanced Theoretical Application",
                    "content": "Complex application of core principles",
                    "explanation": "Advanced problem-solving using core theory",
                    "example": "Sophisticated example requiring deep understanding"
                  }
                ],
                "keyTakeaway": "Advanced application of core theoretical principles"
              },
              {
                "pageNumber": 5,
                "pageTitle": "Core Theory & Principles - Part 5: Mastery Integration",
                "content": "Integration of all theoretical concepts and comprehensive understanding (300-400 words). This page synthesizes all core theory elements.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "integration|synthesis|mastery",
                    "title": "Integrated Theoretical Mastery",
                    "content": "Comprehensive integration of all core concepts",
                    "explanation": "How all theoretical elements work together",
                    "example": "Master-level example integrating all concepts"
                  }
                ],
                "keyTakeaway": "Complete theoretical mastery and integration"
              },
              {
                "pageNumber": 6,
                "pageTitle": "Exam Strategies & Speed Techniques",
                "content": "Time-saving methods and exam-specific strategies for ${examType} (300-400 words). Focus on speed, accuracy, and exam performance.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "shortcut|technique|strategy",
                    "title": "Speed Technique for ${examType}",
                    "content": "Quick calculation method or exam shortcut",
                    "explanation": "How to apply this technique in ${examType} exam",
                    "example": "Practice problem with timing and strategy"
                  }
                ],
                "keyTakeaway": "Key exam strategies and speed techniques"
              },
              {
                "pageNumber": 7,
                "pageTitle": "Common Traps & Error Prevention",
                "content": "Typical mistakes, question traps, and error prevention strategies for ${examType} (300-400 words). Learn to avoid common pitfalls.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "trap|error|prevention",
                    "title": "Common ${examType} Exam Trap",
                    "content": "Typical exam trap or common mistake",
                    "explanation": "How to identify and avoid this trap",
                    "example": "Example showing trap and correct approach"
                  }
                ],
                "keyTakeaway": "Error prevention and trap avoidance mastery"
              },
              {
                "pageNumber": 8,
                "pageTitle": "Exam Readiness & Final Mastery",
                "content": "Final preparation, review techniques, and exam readiness for ${examType} (300-400 words). Consolidate learning for exam excellence.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "review|mastery|exam",
                    "title": "Final Mastery Challenge",
                    "content": "Comprehensive exam-level problem",
                    "explanation": "Complete solution approach with exam strategy",
                    "example": "Final practice problem with time optimization"
                  }
                ],
                "keyTakeaway": "Complete exam readiness and mastery confidence"
              }
            ],
