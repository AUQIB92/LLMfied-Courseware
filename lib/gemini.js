...
export async function generateCompetitiveExamModuleSummary(content, context = {}) {
  ...
  const prompt = `
    ...
    7. Detailed subsections with MULTI-PAGE EXPLANATIONS:
       ...
       - MANDATORY: Page 1: "Introduction & Foundation" (200-300 words) - Basic concepts, definitions, context, exam relevance
       - MANDATORY: Page 2: "Shortcuts & Speed Techniques" (200-300 words) - Time-saving methods, mental math, quick calculations
       - MANDATORY: Page 3: "Practice & Exam Application" (200-300 words) - Real exam problems, patterns, strategic approaches
       - MANDATORY: Page 4: "Advanced Tricks & Common Traps" (200-300 words) - Advanced shortcuts, pitfalls, expert techniques
       - MANDATORY: Page 5: "Mastery & Review" (200-300 words) - Practice problems, review techniques, final tips
       ...
       - FOR MATHEMATICAL CONCEPTS: Include formulas, quick calculation techniques, memory tricks, and numerical examples
       ...
       - FOR QUANTITATIVE APTITUDE: Include speed math, approximation techniques, and formula shortcuts
            ...
            "pages": [
              {
                "pageNumber": 1,
                "pageTitle": "Introduction & Foundation",
                "content": "Basic concepts, definitions, and context for ${examType} exam (200-300 words). This page introduces the fundamental ideas and exam relevance.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "formula|equation|calculation|shortcut",
                    "title": "Mathematical Concept for ${examType}",
                    "content": "Formula or mathematical expression relevant to ${examType} exam",
                    "explanation": "Step-by-step explanation with exam context",
                    "example": "Numerical example with ${examType} exam application"
                  }
                ],
                "keyTakeaway": "Main learning point for ${examType} exam success"
              },
              {
                "pageNumber": 2,
                "pageTitle": "Shortcuts & Speed Techniques",
                "content": "Time-saving methods and mental math techniques for ${examType} exam (200-300 words). Focus on speed and accuracy.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "shortcut|technique|trick",
                ...
                "keyTakeaway": "Key shortcut technique for ${examType} exam"
              },
              {
                "pageNumber": 3,
                "pageTitle": "Practice & Exam Application",
                "content": "Real exam problems and strategic approaches for ${examType} (200-300 words). Show how concepts apply in actual exam conditions.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "example|problem|application",
                    "title": "${examType} Exam Problem",
                    "content": "Typical exam question format",
                    "explanation": "Solution strategy and approach",
                    "example": "Step-by-step solution with time management"
                  }
                ],
                "keyTakeaway": "Strategic approach for ${examType} exam questions"
              },
              {
                "pageNumber": 4,
                "pageTitle": "Advanced Tricks & Common Traps",
                "content": "Advanced shortcuts, pitfalls, and expert techniques for ${examType} (200-300 words). Master complex problem-solving strategies.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "advanced|shortcut|trap",
                    "title": "Advanced Technique for ${examType}",
                    "content": "Expert-level shortcut or common trap",
                    "explanation": "How to master this advanced concept",
                    "example": "Complex problem with expert solution"
                  }
                ],
                "keyTakeaway": "Advanced mastery techniques for ${examType} exam"
              },
              {
                "pageNumber": 5,
                "pageTitle": "Mastery & Review",
                "content": "Practice problems, review techniques, and final tips for ${examType} (200-300 words). Consolidate learning and prepare for excellence.",
                "codeExamples": [],
                "mathematicalContent": [
                  {
                    "type": "review|practice|mastery",
                    "title": "Mastery Challenge for ${examType}",
                    "content": "Comprehensive practice problem",
                    "explanation": "Complete solution approach and review",
                    "example": "Final practice with time optimization"
                  }
                ],
                "keyTakeaway": "Complete mastery and exam readiness"
              }
            ],
