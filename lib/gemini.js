...
export async function generateCompetitiveExamModuleSummary(content, context = {}) {
  ...
  try {
    ...
    console.log(`✅ Successfully generated markdown for module summary. Length: ${responseText.length}`);
...
export async function generateCompetitiveExamSubsectionDetails(content, context = {}) {
  ...
  const prompt = `
    ...
    **Summary:**
    (A brief and engaging summary of the subsection's content, 2-3 sentences.)
    ...
    **Key Learning Points:**
    ...
    (250-350 words of content for this page. Explain the basic concepts, definitions, and context.)
    **Key Takeaway:** (A sentence summarizing the main learning point of this page.)

    #### Core Theory & Mathematical Principles
    (250-350 words of content. Deep dive into the theoretical understanding, formulas, and mathematical foundations.)
    **Key Takeaway:** (A sentence summarizing the main learning point of this page.)

    #### Problem-Solving Techniques & Strategies
    (250-350 words of content. Provide systematic approaches to solving problems related to this subsection.)
    **Key Takeaway:** (A sentence summarizing the main learning point of this page.)

    #### Speed Techniques & Shortcuts
    (250-350 words of content. Focus on time-saving methods, mental math tricks, and rapid calculation techniques.)
    **Key Takeaway:** (A sentence summarizing the main learning point of this page.)

    #### Common Traps & Error Prevention
    (250-350 words of content. Highlight typical mistakes, question traps, and error prevention strategies for the ${examType} exam.)
    **Key Takeaway:** (A sentence summarizing the main learning point of this page.)

    #### Practice Problems & Applications
    (250-350 words of content. Include real exam problems, practice exercises, and application scenarios.)
    **Key Takeaway:** (A sentence summarizing the main learning point of this page.)

    ---

    **Practical Example:**
    (A relevant, practical example demonstrating the concepts of the subsection.)
  ...
  try {
    console.log(`Generating markdown content for subsection: "${subsectionTitle}"`);
    const responseText = await callGeminiWithRetry(model, prompt, 3, 2000);
    console.log(`✅ Successfully generated markdown for subsection "${subsectionTitle}". Length: ${responseText.length}`);
    return responseText.replace(/```markdown/g, "").replace(/```/g, "").trim();
  } catch (error) {
