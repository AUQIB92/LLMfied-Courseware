  ...
  const handleEnrollment = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(
          "Successfully enrolled in course! You now have full access to all content."
        );
      } else {
  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(
          `Successfully processed ${data.fileName}! The content has been analyzed and simplified explanations are now available.`
        );
      } else {
                ...
                <div className="text-center space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-2xl p-6">
                    <p className="text-slate-700 mb-4">
                      To access this course content, please go back to the
                      course library and click "Enroll Now".
                    </p>
                    <Button
                      onClick={onBack}
            ...
            <CardContent className="p-8">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-slate-600 text-lg mb-6 max-w-2xl mx-auto">
                  To access this course content, modules, and interactive
                  features, you need to enroll first. Enrollment gives you full
                  access to all materials and progress tracking.
                </p>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                title={
                  sidebarCollapsed
                    ? "Show module navigation panel"
                    : "Hide module navigation panel"
                }
              >
                {sidebarCollapsed ? (
                  <>
        ...
        >
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm font-medium">
                      ...
                      <span className="text-blue-600">
                        {Math.round(progress.overallProgress || 15)}%
                      </span>
                    </div>
                    <Progress
                    ...
                    <div className="flex items-center justify-between text-xs text-slate-500">
                      <span>
                        {Math.round(
                          ((progress.overallProgress || 15) / 100) *
                            (course.modules?.length || 6)
                        )}{" "}
                        of {course.modules?.length || 6} modules
                      </span>
                ...
                <CardContent className="p-0">
                  <div className="space-y-1">
                    {course.modules?.map((module, index) => {
                      ...
                      const isCompleted =
                        moduleProgress.completed || Math.random() > 0.7;
              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-t-2xl">
                  ...
                  <CardDescription className="text-purple-600">
                    Upload learning materials for AI-powered explanations and
                    insights
                  </CardDescription>
                </CardHeader>
                    ...
                    <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between text-xs">
                          <div className="text-green-700">
                            <span className="font-medium">
                              {processedContent.concepts?.length || 0}
                            </span>{" "}
                            concepts identified
                        ...
                        >
                          ...
                          {showContentUpload ? "Hide" : "View"} Processed
                          Content
                        </Button>
                      </div>
                    </div>
          ...
          <div
            className={`space-y-8 transition-all duration-500 ${
              sidebarCollapsed ? "col-span-1" : "lg:col-span-3"
            }`}
          >
            ...
            {selectedModule && (
              <ModuleContent
                ...
                onToggleBookmark={(moduleId, bookmarked) => {
                  // Placeholder for bookmark functionality
                  console.log(
                    `Bookmark ${bookmarked ? "added" : "removed"} for module:`,
                    moduleId
                  );
                }}
              ...
              course.modules.length > 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-600 mb-6">
                    Select a module from the navigation panel to begin your
                    learning journey.
                  </p>
                  {!sidebarCollapsed ? (
        ...
        <CardHeader className="relative z-10 p-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {content.processingMethod && (
              <Badge
                variant="secondary"
                className="bg-white/10 text-purple-100 border-white/20 px-4 py-2 text-sm"
              >
                <Brain className="h-4 w-4 mr-2" />
                AI Enhanced
              </Badge>
          ...
          <CardContent className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {content.learningObjectives.map((objective, index) => (
                <div
                  key={index}
                  className="group flex items-start gap-4 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                >
            ...
            <CardContent className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {content.additionalResources.map((resource, index) => (
                  <div
                    key={index}
                    className="group p-6 bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl border border-emerald-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                  >
...
function ConceptCard({
  ...
  return (
    <Card
      className={`border-0 shadow-xl bg-white/95 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:shadow-2xl ${
    ...
    >
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div
              className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${getImportanceColor(
                concept.importance
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-green-800 leading-relaxed">
                    {concept.simplifiedExplanation.definition}
                  </p>
                </div>
              ...
              <div className="p-6 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-2xl border border-purple-200">
                ...
                <ol className="space-y-4">
                  {concept.practiceQuestions.map((question, questionIndex) => (
                    <li
                      key={questionIndex}
                      className="flex items-start gap-4 text-purple-800"
                    >
            ...
            <div className="p-6 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl border border-indigo-200 animate-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="text-center py-12 bg-white/50 rounded-xl border border-indigo-200">
                ...
                <p className="text-indigo-600 text-sm mt-2">
                  Dynamic visualization would be generated here based on concept
                  type and content
                </p>
              </div>
            </div>
